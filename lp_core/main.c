...
int main (void)
{
    ...
    err = lp_core_i2c_master_write_to_device(LP_I2C_NUM_0, SFM3003_7BIT_ADDR, cmd, 2, I2C_WAIT_TICKS);
    if (err != ESP_OK) goto exit_point;
    // and take readings
    ...
    if (err != ESP_OK) goto exit_point;
    // Includes 0.5ms delay needed for it to be receptive to further commands
